                    ...
                    <View style={styles.containsView}>
                        <View style={styles.statusStyle}>
                            ...
                            <View style={styles.statusView}>
                                {item.type ? item.type == 'Credit' ? <Text style={styles.historyamounttextStyle}>{item.type + 'ed ' + this.state.settings.symbol + parseFloat(item.amount).toFixed(0) + ' ' + languageJSON.successfully}</Text> :
                                    <Text style={styles.historyamounttextStyle}>{item.type + 'ed ' + this.state.settings.symbol + parseFloat(item.amount).toFixed(0) + ' ' + languageJSON.form_wallet}</Text>
                                    : null}
