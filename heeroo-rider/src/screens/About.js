    ...
    render() {
        return (
            ...
            <View style={styles.mainView}>
                ...
                />
                <ScrollView style={{ flex: 1 }} contentContainerStyle={styles.container} showsVerticalIndicator={false}>
                    ...
                    <TouchableOpacity onPress={() => Linking.openURL('mailto:' + this.state.email)} style={styles.row}>
