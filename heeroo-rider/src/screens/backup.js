...
export default class MScreen extends React.Component {
    ...
    async componentWillMount() {
        ...
        let searchObj = await this.props.route.params.searchObj ? this.props.route.params.searchObj : null;
            ...
            if (searchObj.searchFrom == 'where') {
                ...
                if (searchObj.searchDetails) {
                    this.setState({
                        ...
                        passData: this.props.route.params.old,
            ...
            <View style={styles.mainViewStyle}>
                ...
                <View style={styles.compViewStyle}>
                    ...
                    <View style={{ flex: 0.5 }}>
                        ...
                        >
                            <Text style={{ color: colors.WHITE, fontFamily: 'Montserrat-Bold', fontSize: 18 }}>{languageJSON.book_now_button}</Text>
                        </BaseButton>
