...
export default function Promos() {
  ...
  const availableCountry = () => {
    ...
    if (settingsdata.settings) {
      for (const element of settingsdata.settings) {
        countryArray[element.country] = countryNameFile[element.country]
  ...
  let columns = [
    ...
    {
      title: languageJson.country,
      field: 'country',
      lookup: availableCountry(),
    },
