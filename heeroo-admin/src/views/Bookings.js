...
export default function Bookings() {
    const columns =  [
      { title: languageJson.booking_date, field: 'tripdate', editable:'never', defaultSort:'desc',render: rowData => rowData.tripdate?moment(rowData.tripdate).format("DD.MM.YYYY HH[h]mm"):null},
        { title: languageJson.trip_start_time, field: 'trip_start_time', editable:'never', defaultSort:'desc',render: rowData => moment(rowData.trip_start_time).format("HH[h]mm")},
        { title: languageJson.trip_end_time, field: 'trip_end_time', editable:'never', defaultSort:'desc',render: rowData => moment(rowData.trip_end_time).format("HH[h]mm")},
