...
export default class EditUser extends React.Component {
    ...
    async UNSAFE_componentWillMount() {
        ...
        userData.once('value', userData => {
            this.setState({
                ...
                companyName: userData.val().companyName,
                companyAddress: userData.val().companyAddress,
            });
        })
    }
    ...
    validateCompanyName() {
        ...
        const companyNameValid = companyName.length > 0
        LayoutAnimation.easeInEaseOut()
    ...
    validateCompanyAddress() {
        ...
        const companyAddressValid = companyAddress.length > 0
        LayoutAnimation.easeInEaseOut()
    ...
    onPressRegister() {
        ...
        const companyAddressValid = this.validateCompanyName();

        if (fnameValid && lnameValid && mobileValid && emailValid && companyNameValid && companyAddressValid) {
            //register function of smart component
            onPressRegister(this.state.fname, this.state.lname, this.state.mobile, this.state.email, null, this.state.companyName, this.state.companyAddress);
        }
    }
                        ...
                        <View style={styles.containerStyle}>
                            ...
                            <View style={styles.textInputContainerStyle}>
                                ...
                                <Input
                                    ...
                                    secureTextEntry={false}
                                    blurOnSubmit={true}
                                    onSubmitEditing={() => { this.validateCompanyName(); }}
                                    errorStyle={styles.errorMessageStyle}
                                    inputContainerStyle={styles.inputContainerStyle}
                                    containerStyle={styles.textInputStyle}
                                />
                            ...
                            <View style={styles.textInputContainerStyle}>
                                ...
                                <Input
                                    ...
                                    secureTextEntry={false}
                                    blurOnSubmit={true}
                                    onSubmitEditing={() => { this.validateCompanyAddress(); }}
                                    errorStyle={styles.errorMessageStyle}
                                    inputContainerStyle={styles.inputContainerStyle}
                                    containerStyle={styles.textInputStyle}
                                />
